...
public class PersonsRestResource extends AbstractRestResource<JsonWebSerialDeserial>
{
	...
	public PersonsRestResource(IRoleCheckingStrategy roleCheckingStrategy)
	{
	...
	@MethodMapping(value = "/persons/{personIndex}", httpMethod = HttpMethod.DELETE, produces = RestMimeTypes.TEXT_PLAIN)
	@AuthorizeInvocation("VALID_USER")
